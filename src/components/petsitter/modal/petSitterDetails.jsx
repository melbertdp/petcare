      ...
      <Dialog as="div" className="relative z-[99]" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-[99] overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl lg:max-w-7xl sm:p-6"
              >
                  ...
                  <main className="mx-auto px-4 pt-14 pb-10 sm:px-6 sm:pt-16 sm:pb-10 lg:max-w-7xl lg:px-8">
                    ...
                    <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-4 xl:gap-x-16">
                      ...
                      <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                        ...
                        <p className="mt-3 text-gray-500">{viewVetDetails.description}</p>
                        ...
                        <div className="mt-5 border-t border-gray-200 pt-3">
                          ...
                          <div className="prose prose-sm mt-4 text-gray-500">
                            <p className="mt-0 mb-1">
                              <span className="font-bold">Address:</span> {viewVetDetails.address}
                            </p>
                            <p className="mt-0 mb-1">
                        ...
                        <div className="mt-5 border-t border-gray-200 pt-5">
                          <h3 className="text-lg font-bold text-gray-900">Socials</h3>
                              ...
                              <div className="scrollbar-thumb-gray-500 scrollbar-track-gray-100 scrollbar-thin overflow-y-scroll max-h-[300px]">
...

                                {
                                  viewVetDetails?.reviews?.length > 0 ?
                                    viewVetDetails?.reviews?.map((review, reviewIdx) => (
                                      <div
                                        key={review.id}
                                      ...
                                      >
                                        ...
                                        <div className={classNames(reviewIdx === 0 ? '' : 'border-t border-gray-200', 'flex-1 py-5')}>
                                              ...
                                              {[0, 1, 2, 3, 4].map((rating) => (
                                                <StarIcon
                                                  ...
                                                  className={classNames(
                                                    review.rating > rating ? 'text-indigo-500' : 'text-gray-300',
