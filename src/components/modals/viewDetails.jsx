      ...
      <Dialog as="div" className="relative z-[99]" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-[99] overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl lg:max-w-7xl sm:p-6">
                <div className="bg-white">
                  <main className="mx-auto px-4 pt-14 pb-10 sm:px-6 sm:pt-16 sm:pb-10 lg:max-w-7xl lg:px-8">
                    {/* Product */}
                    <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-4 xl:gap-x-8">
                      {/* Product image */}
                      <div className="lg:col-span-3 lg:row-end-1">
                        {/* <div className="aspect-w-3 aspect-h-3 overflow-hidden rounded-lg bg-gray-100"> */}
                        <div className="margin-auto overflow-hidden rounded-lg bg-gray-100">
                          <img alt="vetlogo" src={viewVetDetails?.imageSrc} />
                        </div>
                      </div>
                      ...
                      <div className="w-full mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-4 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                        ...
                        <div className="mt-5 border-t border-gray-200 pt-3">
                          ...
                          <div className="prose prose-sm mt-4 text-gray-500">
                            ...
                            <p className="mt-0 mb-1">
                              ...
                              {viewVetDetails.price}
                            </p>
                            <p className="mt-0 mb-1">
                              <span className="font-bold mr-1">Phone:</span>{" "}
                              {viewVetDetails.phone}
                            </p>
                            <p className="mt-0 mb-1">
                              <span className="font-bold mr-1">Email:</span>
                              <a
                                className="text-blue-500"
                                href={`mailto:${viewVetDetails.email}`}
                              >
                                {viewVetDetails.email}
                              </a>
                            </p>
                            <p className="flex mt-0 mb-1">
                              <span className="font-bold mr-1">Rating:</span>
                              <Rating
                                rating={viewVetDetails.rating}
                                showRating={false}
                              />
                            </p>
                          </div>
                        ...
                        <div className="mt-5 border-t border-gray-200 pt-5">
                          ...
                          <ul
                            role="list"
                            className="mt-2 flex items-center space-x-6"
                          >
                            <li>
                              <a
                      ...
                      <div className="mx-auto mt-5 w-full max-w-2xl lg:col-span-3 lg:mt-0 lg:max-w-none">
                        <Tab.Group as="div">
                          ...
                          <Tab.Panels as={Fragment}>
                            <Tab.Panel className="-mb-10">
                              <div className="scrollbar-thumb-gray-500 scrollbar-track-gray-100 scrollbar-thin overflow-y-scroll max-h-[300px]">
                                <h3 className="sr-only">Customer Reviews</h3>

                                {viewVetDetails?.reviews?.length > 0 ? (
                                  viewVetDetails?.reviews?.map(
                                    (review, reviewIdx) => (
                                      <div
                                        key={review.id}
                                        className="flex space-x-4 text-sm text-gray-500 px-5"
                                      >
                                        ...
                                        >
                                          <h3 className="flex font-medium text-gray-900 space-x-2">
                            ...
                            <Tab.Panel className="text-sm text-gray-500">
                              ...
                              {viewVetDetails?.faq?.length > 0 ? (
                                viewVetDetails?.faqs?.map((faq) => (
